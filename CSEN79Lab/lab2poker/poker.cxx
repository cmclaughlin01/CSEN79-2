...
namespace csen79 {
	...
	const std::unordered_map<Poker::Rank, int> Poker::RankToIndex = {
		{Poker::POKER_HIGHCARD, 0},
		{Poker::POKER_PAIR, 1},
		{Poker::POKER_2_PAIR, 2},
		{Poker::POKER_TRIPLE, 3},
		{Poker::POKER_STRAIGHT, 4},
		{Poker::POKER_FLUSH, 5},
		{Poker::POKER_FULLHOUSE, 6},
		{Poker::POKER_QUAD, 7},
		{Poker::POKER_STRAIGHT_FLUSH, 8}
	};
